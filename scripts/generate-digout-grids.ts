// Generates Digout grid JSON files (src/app/digout/grids/<date>.json).
//
// Usage:
//   npx tsx scripts/generate-digout-grids.ts
//     Regenerates today, the 10 previous days, and the 10 following days.
//
//   npx tsx scripts/generate-digout-grids.ts 2026-08-01 2026-08-02
//     Regenerates only the given dates.
//
//   npx tsx scripts/generate-digout-grids.ts --range 2026-08-01 2026-08-14
//     Regenerates every date in the inclusive range.
import { writeFile } from "node:fs/promises";
import path from "node:path";
import { createGrid, generateShapeMap, GRID_SIZE, MINE_COUNT } from "../src/app/digout/game-logic";
